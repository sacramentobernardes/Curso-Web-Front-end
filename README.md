# 📚 Meus Estudos e Anotações Técnicas sobre o curso Web-Front-end

Bem-vindo ao meu repositório de aprendizado! 🚀

Aqui eu documento minha jornada de desenvolvimento Front_End, guardando soluções úteis, snippets de código e guias rápidos para consulta diária.
O objetivo é transformar conhecimento teórico em referência prática.

## 📂 O que você vai encontrar aqui:

* **HTML:** Estrutura semântica, tags essenciais para acessibilidade e formulários robustos.
